...
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" CREATE BYE :"$ku" Pawanji Mandal"$i"          |"
echo $i" |"$pu" FACEBOOK :"$ku" Pawanji Mandal"$i"                           l"
echo $i" |"$pu" Contack WhatsApp :"$ku" +917542891591"$i"             |"
echo $i" |"$pu" Contack Gmail :"$ku" pawanjimadal@gmail.com"$i"      |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
...
sleep 2
echo $ku"WhatsApp :"$i" +917542891591"
echo $ku"Facebook :"$i" Pawanji Mandal"
sleep 2
